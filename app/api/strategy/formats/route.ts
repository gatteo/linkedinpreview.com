...
import { bodySchema, formatsSchema } from './route.schema'
...
export async function POST(request: Request) {
    ...
    try {
        const { object } = await generateObject({
            ...
            schema: formatsSchema,
            system: STRATEGY_FORMATS_SYSTEM_PROMPT,
            prompt: strategyFormatsUserPrompt(parsed.data),
        })
