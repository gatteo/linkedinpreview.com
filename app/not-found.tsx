    ...
    return (
        <div className='flex min-h-[80vh] flex-col items-center justify-center gap-8 px-6'>
            <div className='text-center'>
                <p className='text-muted-foreground mb-2 text-sm font-medium tracking-wider uppercase'>404</p>
                <h1 className='font-heading text-foreground mb-4 text-4xl font-bold'>Page not found</h1>
