...
const fieldVariants = cva('group/field flex w-full gap-2 data-[invalid=true]:text-destructive', {
    variants: {
        orientation: {
            ...
            horizontal:
                '[&>[role=checkbox],[role=radio]]:has-[>[data-slot=field-content]]:mt-px flex-row items-center has-[>[data-slot=field-content]]:items-start data-[slot=field-label]:*:flex-auto',
            responsive:
                '@md/field-group:flex-row @md/field-group:items-center @md/field-group:*:w-auto @md/field-group:data-[slot=field-label]:*:flex-auto @md/field-group:has-[>[data-slot=field-content]]:items-start @md/field-group:[&>[role=checkbox],[role=radio]]:has-[>[data-slot=field-content]]:mt-px flex-col *:w-full [&>.sr-only]:w-auto',
        },
    },
    defaultVariants: {
