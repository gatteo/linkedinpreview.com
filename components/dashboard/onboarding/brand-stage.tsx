...
const STAGE: Record<StepId, Stage> = {
    ...
    reinforce: {
        ...
        eyebrow: 'The pattern',
        title: 'Consistency\ncompounds.',
        sub: 'What the strongest presences in your space have in common.',
        focus: '50% 55%',
    },
    building: {
    ...
    insights: {
        ...
        title: 'Where you\nstand today.',
        sub: 'Your starting point, measured - and the gap worth closing.',
        focus: '50% 45%',
    },
    preview: {
        img: 'sailboat.jpg',
        ...
        sub: 'Written to fill your gap, in your voice.',
        focus: '55% 50%',
    },
    recap: {
        img: 'tuscan-hills.jpg',
