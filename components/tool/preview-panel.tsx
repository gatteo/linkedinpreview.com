            ...
            <div className="py-3 pl-4 pr-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center justify-start gap-2">
                  ...
                  />
                  <span
                    className={cn("mt-1 font-medium text-gray-500", screenSize === "mobile" ? "hidden" : "text-xs")}
                  >
                    Devv and 88 others
                  </span>
                </div>
              ...
              <div
                className={cn("mt-2 flex items-center", screenSize === "mobile" ? "justify-between" : "justify-around")}
              >
