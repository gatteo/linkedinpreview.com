...
image: '/images/blog/ai-linkedin-post-generator-guide/og.png'
authorId: matteo
...
<CtaCard
    ...
    primaryButtonUrl='/linkedin-post-generator'
    pattern='circles'
    align='center'
/>
...
Our built-in [LinkedIn post generator](/linkedin-post-generator) is free to use with no account required. You generate a draft, format it, and preview it - in the same place.
