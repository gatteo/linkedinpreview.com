...
- [x] 231-AC-10 The paywall sells the real PRICING (lifetime plan + monthly) through the embedded Stripe checkout, with no scarcity or founding-window claim. A quiet "Continue on the free plan" always exists (also on checkout failure). _(verified: `steps/paywall-step.tsx`; `config/pricing.ts`; updated 2026-08-29)_
